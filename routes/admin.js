...
router.get("/listOfAdminUsers", function (req, res) {
  return databaseStore.checkAdminStatusAsync(req.user["id"])
    .then(function (adminStatus) {
      if (adminStatus == true) {
...
router.post("/deleteAdminUser", function (req, res) {
  return databaseStore.checkAdminStatusAsync(req.user["id"])
    .then(function (adminStatus) {
      if (adminStatus == true) {
...
router.post("/whitelistUser", function (req, res) {
...
router.post("/deleteWhitelistedUser", function (req, res) {
  let repo = req.body["repoName"]
  let userName = req.body["userName"]
...
router.post("/setCLARequirements", function (req, res) {
  let repo = req.body["repoName"]
...
router.post("/getCLARequirement", function (req, res) {
  let repo = req.body["repoName"]
